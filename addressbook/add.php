<?php
    ...
    if(isset($_POST['add'])){
        ...
        //store whatever is entered in variables
        ...
        if($clientName && $clientEmail){
            ...
            //create query
            $query      = "INSERT INTO clients (id, name, email, phone, address, company, notes, date_added) VALUE(NULL, '$clientName', '$clientEmail', '$clientPhone', '$clientAddress', '$clientCompany', '$clientNotes', CURRENT_TIMESTAMP)";
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="row">
    ...
    <div class="col-sm-12">
        <a href="client.php" type="button" class="btn btn-lg btn-default" Cancel>My Clients</a>
